...
namespace Purchaseproweb.Controllers
{
    public class BaseController : Controller
    {
            ...
            {
                {
                    ...
                    {
                        string claim = GetClaim((User as ClaimsPrincipal).Claims.ToList(), "userData");
                    ...
                    ViewData["UserData"] = userDataSerializeModel ?? new UsermodelResponce();
                    if (userDataSerializeModel == null)
                    {
                        string url = Url.Action("Signinuser", "AccountManagement");
        ...
        {
            Claim claim = claims.FirstOrDefault((c) => c.Type == key);
            if (claim == null)
            {
                return null;
            }
